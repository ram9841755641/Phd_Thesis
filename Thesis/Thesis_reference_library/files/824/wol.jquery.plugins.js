...
c.addClass("hover");
var d=Math.floor(i.offset().top)+Math.floor(i.outerHeight())+40;
if(d>h){var g=h-d;
i.css("top",g)
}};
...
a.fn.loginLabels=function(){return this.each(function(){if(a(this).val()!=""){a(this).prev().hide()
...
if(h.find("option").length===1){h.append(options).css("zoom",1)
}});
...
a.fn.socialBookmarks=function(){return this.each(function(){var c='<a href="http://www.addthis.com/bookmark.php?v=250&amp;username=xa-4cbc15896d9442fa" class="addthis_button_compact">Share</a>',d='<span class="addthis_separator">|</span>',b='<a class="addthis_button_citeulike"></a><a class="addthis_button_connotea"></a><a class="addthis_button_delicious"></a><a class="addthis_button_www.mendeley.com"></a><a class="addthis_button_twitter"></a>';
...
}a.ajax({type:"POST",data:a(h).serialize(),url:h.attr("action"),success:function(o){try{(o==="")?b("The payment process has timed out."):c(JSON.parse(o),"post");
g(k)
}catch(p){g(k);
b(l)
