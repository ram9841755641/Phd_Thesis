...
s.linkInternalFilters="javascript:,onlinelibrary.wiley.com,olabout.wiley.com,ordering.onlinelibrary.wiley.com,doi.wiley.com";
...
function s_doPlugins(s) {
		if(document.title && s.pageName=="") s.pageName=document.title.replace(" - Wiley Online Library","");
		...
		if(typeof(PageInitTime)!=='undefined'){
			s.events=s.apl(s.events,'event32',',',1); //page speed metric
			s.pageSpeed=Math.round(((new Date()).getTime()-PageInitTime)/100)/10;
			if(s.products) s.products+=",;;;;event32=" + s.pageSpeed;
			else s.products= ";;;;event32=" + s.pageSpeed;
		}
		if(s.prop20){
