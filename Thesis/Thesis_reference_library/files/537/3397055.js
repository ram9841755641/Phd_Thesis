...
// Enable firebug-lite by adding request parameter
if (window.location.href.indexOf('firebug') > -1)
{
    document.writeln('<scri'+'pt '+'src="'+'http://dev.ncbi.nlm.nih.gov/ipmc-dev1/stan/renderer/corehtml/pmc/firebug-lite/build/firebug-lite.js#startEnabled=true'+'">'+'</script'+'/>');
}
