    ...
    function j(o, q) {
        ...
        if (!this.bu_icon) {
            ...
            if (this.bu_icon == "none") {
                this.bu_icon = "/_layouts/1033/images/oaks.journals/icons.png"
            }
            p.remove()
        }
        ...
        this.imgList = [{
            loaded: false,
            src: this.bu_icon || "/_layouts/1033/images/oaks.journals/icons.png"
        }, {
            loaded: false,
    ...
    j.prototype = {
        loadComplete: function (r) {
            ...
            if (n) {
				...
				//alert(q);
                //if (m.indexOf(q) > -1) {
				if (o.$image != undefined) //make sure there is an image before attempting to process the image
				{
                    o.init()
				}
                //}
