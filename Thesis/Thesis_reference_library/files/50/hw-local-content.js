...
$(document).ready(function() {
   ...
   // to hide indicator 
    ...
    //a hack to handle HW citing articles link in sidebar
    //these methods already exists in the /shared/js/pages/hw-content.js
    //see SF #00129919 for further details
