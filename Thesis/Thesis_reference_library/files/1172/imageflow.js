...
domReady(function()
{
	...
	instanceTwo.init({ ImageFlowID: 'cen', captions:false, sliderCursor:'default', reflections:false, reflectionP: 0.2, startID: 5, aspectRatio: 2, xStep: 120 });
		
	var instanceThree = new ImageFlow();
	instanceThree.init({ ImageFlowID: 'slideShowlg', captions:false, sliderCursor:'default', reflections:false, reflectionP: 0.07, startID: 1, aspectRatio: 1.20, imageFocusM: 2, imagesHeight: 0.75, scrollbarP: 0.8, xStep: 120 });

	var instanceFour = new ImageFlow();
	instanceFour.init({ ImageFlowID: 'events', captions:true, sliderCursor:'default', reflections:false, reflectionP: 0.02, startID: 1, aspectRatio: 1.75, imageFocusM: 2.20, imagesHeight: 0.75, scrollbarP: 0.8, xStep: 140 });
	});