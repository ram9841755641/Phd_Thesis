    ...
    function Tweet(tweet) {
      ...
      var html = '<div class="twtr-tweet-wrap"> \
        <div class="twtr-avatar"> \
          <div class="twtr-img"><a target="_blank" href="http://twitter.com/' + tweet.user + '"><img style="width:20px;height:20px;" alt="' + tweet.user + ' profile" src="' + matchUrlScheme(tweet.avatar) + '"></a></div> \
        </div> \
          ...
          if (features) {
            ...
            if (is.def(features.avatars) && is.bool(features.avatars)) {
              ...
              if (!features.avatars) {
                ...
                var margin = (this._isFullScreen) ? '90px' : '30px';
                twttr.css('#' + this.id + ' .twtr-avatar { width:30px;height:30px;display: block; } #' + this.id + ' .twtr-user { display: inline; } ' +
