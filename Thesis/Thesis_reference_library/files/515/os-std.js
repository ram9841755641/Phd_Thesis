...
/* /assets/r2013.1.3-0/pqc/components/Overlay.js */;
...
/* /assets/r2013.1.3-0/pqc/javascript/tinybox2/tinybox.js */;
TINY = {};
...
/* /assets/r2013.1.3-0/pqc/javascript/prototip/js/event.simulate.js */;
/**
...
/* /assets/r2013.1.3-0/pqc/components/InfoBubble.js */;
...
/* /assets/r2013.1.3-0/pqc/components/PauseSession.js */;
...
/* /assets/r2013.1.3-0/core/corelib/components/linksubmit.js */;
//
...
/* /assets/r2013.1.3-0/core/corelib/components/ProgressiveDisplay.js */;
...
/* /assets/r2013.1.3-0/app/base/SelectLimitersEvent.js */;
...
/* /assets/r2013.1.3-0/app/components/EmailItem.js */;
...
/* /assets/r2013.1.3-0/app/components/PreviewOptionsBar.js */;
//empty.
/* /assets/r2013.1.3-0/app/components/FieldBrowseIndex.js */;
...
/* /assets/r2013.1.3-0/app/components/ImageViewOptionsBar.js */;
...
/* /assets/r2013.1.3-0/app/components/PageLayoutPdf.js */;
var dragMode=false;
var obj=""
...
/* /assets/r2013.1.3-0/app/components/SimilarRecords.js */;
...
/* /assets/r2013.1.3-0/app/components/SaveAsFile.js */;
...
/* /assets/r2013.1.3-0/app/components/RelatedDocumentParts.js */;
...
/* /assets/r2013.1.3-0/app/components/SupplementalFiles.js */;
...
/* /assets/r2013.1.3-0/app/components/Tagging.js */;
...
/* /assets/r2013.1.3-0/app/components/WhoTagged.js */;
...
/* /assets/r2013.1.3-0/app/components/ExternalLink.js */;
...
/* /assets/r2013.1.3-0/app/components/RefWorksDocExport.js */;
...
/* /assets/r2013.1.3-0/app/components/RightToLeftInformation.js */;
...
/* /assets/r2013.1.3-0/app/components/AddThis.js */;
var AddThis = Class
		.create({
...
/* /assets/r2013.1.3-0/app/components/SearchWithIndexTerms.js */;
...
/* /assets/r2013.1.3-0/app/components/ItemInSharedList.js */;
...
/* /assets/r2013.1.3-0/app/components/alertrss/AlertRss.js */;
...
/* /assets/r2013.1.3-0/app/components/alertrss/SearchEmailAlertLinks.js */;
...
/* /assets/r2013.1.3-0/app/components/alertrss/SearchEmailAlertCreateDialog.js */;
document.createElement("footer"); //IE CSS fix or footer element.

var SearchEmailAlertCreateDialog = Class.create({
	initialize : function(spec) { },

	//Attach submit button behavior
	submitButtonBehavior: function(containerEl){
		//disable submit buttons after first click.
		var disableButtons = $(containerEl).select("button[disableonsubmit]");
		for (var i=0,l=disableButtons.length; i<l; ++i){
			(function(button){
				$(button).on('click', function(evt){
					//wrapped in timeout because the act of setting the disabled flag will disable the button.
					setTimeout(function(){
	...
	checkMultiAddrField: function (selectedElement) {
		this.clientId = getClientId(selectedElement);
		var multiAddrField = $('multipleEmailAddressField'+this.clientId);
		var deliverCheck = $('emailDeliveryMultiple' + this.clientId);
		multiAddrField.disabled = !deliverCheck.checked && !this.isInputEmpty(multiAddrField);
	},
	...
	checkMultiDeliveryFlag: function(selectedElement) {
		...
		var multiAddrField = $('multipleEmailAddressField'+this.clientId);
		var deliverCheck = $('emailDeliveryMultiple' + this.clientId);
		deliverCheck.checked = !this.isInputEmpty(multiAddrField);
	},
	isInputEmpty: function(inputEl) {
		return ($F(inputEl).blank());
	}
});

Tapestry.Initializer.searchEmailAlertCreateDialog = function(spec) {
	window.searchEmailAlertCreateDialog = new SearchEmailAlertCreateDialog(spec);
};

//SearchEmailAlertCreateDialog namespace
var seacd = window.seacd || {};

seacd.frequencySelection = function(selectedFrequency, zoneId) {
	switch (selectedFrequency.value){
		case 'EveryFourHours':
			$('everyFourHours_' + zoneId).show();
			$('daily_' + zoneId).hide();
			$('weekly_' + zoneId).hide();
			$('monthly_'+ zoneId).hide();
			break;
		case 'Daily':
			$('everyFourHours_' + zoneId).hide();
			$('daily_' + zoneId).show();
			$('weekly_' + zoneId).hide();
			$('monthly_'+ zoneId).hide();
			break;
...
// For HTML, show the Highlighting radio.
// PQ-5377: For HTML, PDF, RTF, or Text, include the "custom" format in the "Display Format" menu.
seacd.onChangeSendAs = function(selectedFormatEl, zoneId){
	var selectedFormat = selectedFormatEl.value;

	switch (selectedFormat.toLowerCase()) {
		case 'html':
			$('hithilight_' + zoneId).show();
			seacd.provideCustomDisplayFormatOption(true);
			break;
		case 'pdf':
		case 'rtf':
		case 'text':
		...
		default:
			$('hithilight_' + zoneId).hide();
			seacd.provideCustomDisplayFormatOption(false);
	}
	seacd.updateFieldNames($$('select[name=documentDetails]')[0]);
};

seacd.updateFieldNames = function(el){
...
seacd.provideCustomDisplayFormatOption = function(includeCustom){
...
function toggleAlertTip(alerthelptip, pricinghelptip) {
	if (alerthelptip != null) { alerthelptip.show(); }
	if (pricinghelptip != null) { pricinghelptip.hide(); }
}

function togglePricingTip(alerthelptip, pricinghelptip) {
...
function showDeliveryMethod(ctrlSelected,zoneId){
	var selected;
	var clientId;
	if (typeof ctrlSelected != 'string') {
		selected = ctrlSelected.value;
		clientId = getClientId(ctrlSelected);
	} else {
...
function onChangeInclude(selectedInclude, zoneId){
	clientId = getClientId(selectedInclude); 
	if (selectedInclude.value == 'Newly_added_documents_and_updated_documents'){
		$('fieldselection_' + zoneId).show();
		$('patentsAnyField'+ clientId).value = 'patentsAnyField';
	} else {
		$('fieldselection_' + zoneId).hide();
	}
}

function enablePatentsFieldsSelection(fieldsSelection){
	clientId = getClientId(fieldsSelection); 
	if (fieldsSelection.value == 'patentsSelectedField'){
		$('selectAll_patentsCBFields' + clientId).disabled = false;
		$$('.option_patentsCBFields').each(function(item){
			item.enable();
		});
	} else {
		$('selectAll_patentsCBFields' + clientId).disabled = true;
		$$('.option_patentsCBFields').each(function(item){
			item.disable();
		});
	}
...
function getClientId(anElement) {
	var anId = anElement.id;
	return anId.substring(anId.indexOf('_'));
}
/* /assets/r2013.1.3-0/app/components/alertrss/SearchEmailAlertCreate.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/CiteThis.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/TextPlusGraphicsContainer.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/TranslateFieldLink.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/PinkynailsContainer.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/AuthorResolverSetup.js */;
var su_linkstyle = 1;


/* /assets/r2013.1.3-0/app/components/citation/DocViewLink.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/TranslationContainer.js */;
...
/* /assets/r2013.1.3-0/app/components/citation/view/ShowLimit.js */;
...
/* /assets/r2013.1.3-0/app/components/docview/Abstract.js */;
...
Tapestry.Initializer.AbstractSummaryBlock = function() {
	...
	var showAllScrolling = false;
	var t = $('hitnavigationswitch');
		if (t != null)
			t.fire("hitnav:refresh");
		if(showAllScrolling) {
			$('fullTextHeader').scrollTo();
		} else {
			showAllScrolling = true;
	}						
};

/* /assets/r2013.1.3-0/app/components/docview/FullText.js */;
...
/* /assets/r2013.1.3-0/app/components/docview/FullCitation.js */;
...
/* /assets/r2013.1.3-0/app/components/docview/HeaderTitle.js */;
...
/* /assets/r2013.1.3-0/app/components/docview/IntelliDocBase.js */;
function getIdlWin(url,title)
{
	var newWindow=window.open("", "mywindow", "width=690,height=600,toolbars=no,menubar=no,location=no,scrollbars=yes,resizable=yes,status=yes");
	var tmp = newWindow.document;
...
/* /assets/r2013.1.3-0/app/components/database/DatabasePageLinkEvent.js */;
...
/* /assets/r2013.1.3-0/app/components/database/DatabaseCheckbox.js */;
...
/* /assets/r2013.1.3-0/app/components/database/DbView.js */;
...
/* /assets/r2013.1.3-0/app/components/markedlist/SelectedItemsLink.js */;
...
/* /assets/r2013.1.3-0/app/components/markedlist/SelectedItemsCount.js */;
...
/* /assets/r2013.1.3-0/app/components/markedlist/SaveToMyResearchOverlay.js */;
...
/* /assets/r2013.1.3-0/app/components/markedlist/SaveToMyResearchLink.js */;
...
/* /assets/r2013.1.3-0/app/components/markedlist/SelectedItemsClear.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/SignInOverlay.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/SignInForm.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/CreateProfileOverlay.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/PreferencesLink.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/SaveSearchLink.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/SaveSearchOverlays.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/PrintLayer.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/CheckSelectedItems.js */;
...
/* /assets/r2013.1.3-0/app/components/myresearch/MyResearchRequestItem.js */;
...
/* /assets/r2013.1.3-0/app/components/search/BrowseIndexRow.js */;
...
/* /assets/r2013.1.3-0/app/components/search/ExposedSearchField.js */;
...
/* /assets/r2013.1.3-0/app/components/search/SearchLimitersCheckboxGroup.js */;
...
/* /assets/r2013.1.3-0/app/components/search/ToggleHitHighlighting.js */;
...
/* /assets/r2013.1.3-0/app/components/search/SmartSearchResults.js */;
...
/* /assets/r2013.1.3-0/app/components/search/SearchRunningWarning.js */;
var timeout=4000;
...
/* /assets/r2013.1.3-0/app/components/search/PopupSubjectList.js */;
...
/* /assets/r2013.1.3-0/app/components/search/BasicSearchBox.js */;
...
/* /assets/r2013.1.3-0/app/components/search/SmartSearchDetectOverflow.js */;
/*
...
/* /assets/r2013.1.3-0/app/components/search/BrowseIndexQueryBuilderThesaurusAware.js */;
...
/* /assets/r2013.1.3-0/app/components/search/DisplayDatabaseList.js */;
...
/* /assets/r2013.1.3-0/app/components/search/ExpandedBasicSearchBox.js */;
...
/* /assets/r2013.1.3-0/app/components/search/RecentSearchTabView.js */;
...
/* /assets/r2013.1.3-0/app/components/search/RecentSearchItem.js */;
var resultsList ={};
var running = false;
function doUpdate(delay) {
	...
	if (hasItems(resultsList) && (hasPending || hasError)) {
		...
		new Ajax.Request(recCountUrl, {
			...
			onSuccess: function(data) {
								...
								if (searchItem && (searchItem.status == 'Pending' || (searchItem.status == 'Error' && !searchItem.errorDisplayed))) {
									...
									if (result.error || result.errorHeaderMessage) {
										...
										if (result.errorHeaderMessage == 'Timeout') {
											...
											/*link = "<a onclick=\"javascript:showErrorOverlay('" + resultId + "');return false;\">Error</a>";
											var template_error_message=$("template-error-message");
											var error = template_error_message.clone(true);
											template_error_message.insert({after: error});
											error.removeClassName("hidden-template");
											error.writeAttribute("id", "error_mesage_" + resultId);
											error.select("p.errorMessageHeaderText").update(result.errorHeaderMessage);
											error.select("p.errorMessage").update(result.error);
											*/
											link = "Error"
										...
										var newVal = result.count;
										if (result.dupRemoval) {
											newVal = newVal + "*";
										}
				...
				if (hasPending) {
					if (updated) {
						setTimeout(function() {doUpdate(delay);}, delay);
					} else {
						setTimeout(function() {doUpdate(delay*1.25);},delay * 1.25);	
					}
				}
			},
			onFailure: function(data) {
				running = false;
				setTimeout(function() {doUpdate(delay*2);},delay*2);
			}
		});
	}
};
...
function showErrorOverlay(resultID) {
	var errorMessage = $("error_mesage_" + resultID);
	var errorBody = errorMessage.select("p.errorMessage")[0].innerHTML;
	$$(".errorOverlay p.errorText").update(errorBody);
	Overlay.box.getOverlay("query_error_overlay").showOverlay();
}
...
document.observe("dom:loaded", function() {setTimeout(function() {doUpdate(5000);}, 3000);});
/* /assets/r2013.1.3-0/app/components/resultsfiltering/ActiveButtons.js */;
...
/* /assets/r2013.1.3-0/app/components/thesaurus/ThesaurusBrowse.js */;
...
function disableParentLayer(){
    ...
    enableOrDisableEventLink(true);
  	document.getElementById("thesaurusOverlayLayer").style.display = 'block';
}
...
/* /assets/r2013.1.3-0/app/components/thesaurus/ThesaurusTrigger.js */;
var wind;
var lastFocused;
...
/* /assets/r2013.1.3-0/app/components/thesaurus/HierarchicalFieldBrowseIndex.js */;
...
/* /assets/r2013.1.3-0/app/components/visualdesign/MainContentLeft.js */;
...
/* /assets/r2013.1.3-0/app/components/visualdesign/CollapsibleSection.js */;
...
/* /assets/r2013.1.3-0/app/components/thirdparty/ForeSeeSurvey.js */;
...
/* /assets/r2013.1.3-0/app/validation/usernameValidator.js */;
...
/* /assets/r2013.1.3-0/app/pages/PagePdf.js */;
...
/* /assets/r2013.1.3-0/app/base/alertrss/SearchAlertsBase.js */;
